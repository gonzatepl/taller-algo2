...
public:
    ...
    //UBICA A ACTUAL EN EL PRIMER ELEMENTO DE LA LISTA
    void posicionarAdelante();
    ...
    //UBICA A ACTUAL EN EL ULTIMO ELEMENTO DE LA LISTA
    void posicionarAtras();
...
private:
    ...
    //Elemento más a la izquierda de la Lista doblemente enlazada
    //Nodo* _prim;
    //Elemento más a la derecha de la Lista doblemente enlazada
    //Nodo* _ult;
